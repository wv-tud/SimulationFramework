...
add_args    = {[0 0 10; 0 30 10; -50 -30 10; 50 -30 10; 0 30 10; 0 0 10] 1 0 0 [0 0 10; 0 30 10; -50 -30 10; 50 -30 10; 0 30 10; 0 0 10] 1 0 0};
%names                   = {'waypoint' 'waypoint'};
%add_args                = {[0 0 10 0; 0 0 10 20] [0 0 10 0; 0 0 10 20]};
v_max = 1.5;
