        ...
        function y = local_interaction(obj,x)
            ...
            switch(obj.net.numLayers)
                case 2 % One hidden layer
                    y = obj.net.b{2} + obj.net.LW{2} * radbas(obj.net.IW{1} * obj.nnNormI(x) + obj.net.b{1});
                case 3 % Two hidden layers
                    y = obj.net.b{3} + obj.net.LW{3,2} * radbas(obj.net.LW{2,1} * radbas(obj.net.IW{1} * obj.nnNormI(x) + obj.net.b{1}) + obj.net.b{2});
                otherwise
                    y = zeros(1,length(x));
