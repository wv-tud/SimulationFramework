...
% simulations{i}.LB       = -5 * ones(1,13);
% simulations{i}.UB       =  5 * ones(1,13);
% i = i + 1;
...
for si = 1:length(simulations)
    switch simulations{si}.type 
        ...
        case 'polynomial'
            ...
            simPar.nnAgents         = 0;
            simPar.sinusoidAgents   = 0;
            sampleGenome            = [0 0 0 0 0 0 -0.12 0 0 0 0 0 0.12];
        case 'sinusoid'
            ...
            sampleGenome            = [-0.0267 -5.4729 0.1886 0.7875 0.9981 34.0776 0.6417 1.3918 37.7451 0.9187 1.4766 15.6458 0.9927];
        case 'simpleNN'
