...
simulations{i}.LB       = [0  -5 * ones(1, simulations{i}.genomeNetLength)];
simulations{i}.UB       = [0.25 5 * ones(1, simulations{i}.genomeNetLength)];
simulations{i}.LB(IB+1) = -15;
simulations{i}.UB(IB+1) =  15;
simulations{i}.LB(OB+1) = -15;
simulations{i}.UB(OB+1) =  15;
i = i + 1;
